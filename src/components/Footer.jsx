...
const Footer = () => {
  ...
  const myEmail = "hqim1709@gmail.com";

  return (
    <div>
      <footer className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-gradient-to-t from-black to-highlight text-transparent">
        <div className="text-center">
          <div className="mt-3">
            ...
            <p className="text-gray-400">
              ...
              <a className="font-bebas text " href="#">
                {" "}
                hakim
              </a>
            </p>
          ...
          <div className="mt-3 space-x-2">
            ...
            <a
              className="inline-flex justify-center items-center w-10 h-10 text-center text-gray-500 hover:bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800"
              href="https://www.linkedin.com/in/its-hakim/"
              target="_blank"
            ...
            <a
              className="inline-flex justify-center items-center w-10 h-10 text-center text-gray-500 hover:bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800"
              href="https://github.com/esthakim/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
            ...
            <a
              className="inline-flex justify-center items-center w-10 h-10 text-center text-gray-500 hover:bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800"
              href="https://yog3.slack.com/team/U06736CNV1S"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
